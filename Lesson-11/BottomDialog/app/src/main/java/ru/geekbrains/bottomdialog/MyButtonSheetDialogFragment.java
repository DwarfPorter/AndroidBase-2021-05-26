...
public class MyButtonSheetDialogFragment extends BottomSheetDialogFragment {

    private OnDialogListener dialogListener;

    public static MyButtonSheetDialogFragment newInstance() {
        return new MyButtonSheetDialogFragment();
    }
